...
**a. El duelo de cartas** El juego de Aixec consta de un duelo de cartas multijugador en el que dos jugadores tienen que desplegar cartas con diversos efectos y comportamientos para reducir la salud de su adversario a cero.

**b. El tablero** El tablero consta de los mazos, las manos, los cementerios y campos de batalla de ambos jugadores. Un mazo consta de 20 cartas y al empezar la partida tendrás cinco cartas en la mano.
...
**d. Maná y despliegue** Cada jugador tiene su propio recurso de maná, que se rellena al final de cada turno y aumenta su capacidad máxima en uno hasta un límite de ocho. Solo se puede desplegar un máximo de tres monstruos a la vez en el campo de batalla por cada jugador.
